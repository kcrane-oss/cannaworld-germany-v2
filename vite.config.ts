...
export default defineConfig(() => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ["favicon.svg", "cannaworld-mark.webp", "cannaworld-mark.png"],
      workbox: {
      ...
      manifest: {
        ...
        icons: [
          ...
          { src: "/cannaworld-mark.png", sizes: "192x192", type: "image/png" },
          { src: "/cannaworld-mark.png", sizes: "512x512", type: "image/png", purpose: "any maskable" },
        ],
      },
    }),
