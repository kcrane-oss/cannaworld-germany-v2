...
export default function Analytics() {
  ...
  return (
    <div className="space-y-7">
      <section className="relative overflow-hidden rounded-2xl border border-purple-400/25 bg-gradient-to-br from-purple-400/12 via-white/[0.045] to-cyan-400/10 p-6 shadow-[0_0_42px_rgba(168,85,247,0.08)] md:p-8">
        <div className="absolute right-0 top-0 h-52 w-52 rounded-full bg-purple-400/10 blur-3xl" />
        <div className="absolute inset-x-0 top-0 h-0.5 rounded-t-2xl bg-gradient-to-r from-purple-400 via-violet-400 to-blue-300" />
      ...
      <section className="grid gap-4 md:grid-cols-4">
        {[
          ...
          const Icon = m.icon;
          return (
            <div key={m.label} className="rounded-2xl border border-white/10 bg-white/[0.045] p-5">
      ...
      <section className="rounded-2xl border border-white/10 bg-white/[0.04] p-5 text-xs text-white/45">
        {t(
