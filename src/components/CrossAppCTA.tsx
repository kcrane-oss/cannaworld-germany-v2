...
const CrossAppCTA = ({ moduleKey }: CrossAppCTAProps) => {
  ...
  return (
    <section
      className={`relative overflow-hidden rounded-[2rem] border bg-gradient-to-br p-6 shadow-[0_0_28px_rgba(34,211,238,0.05)] backdrop-blur ${tint.ring} ${tint.bg} ${tint.hoverBorder} transition`}
    >
